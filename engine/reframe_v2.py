...
def render(input_video, final_output_video, aspect_ratio, content_ranges=None,
    ...
    m._timing_start("reframe_scene_detect")
    scenes, fps = m.detect_scenes(input_video)
    m._timing_end("reframe_scene_detect")
    ...
    segments = []
    try:
        m._timing_start("reframe_render_segments")
        ...
        m._timing_end("reframe_render_segments")
    finally:
        import shutil
